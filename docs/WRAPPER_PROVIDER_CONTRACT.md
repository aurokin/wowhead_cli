...
- `simc` is ready for direct local repo workflows and readonly APL inspection, with `search` and `resolve` intentionally returning structured `coming_soon` payloads
