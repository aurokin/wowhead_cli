...
Shared auth direction is defined in [AUTH_ARCHITECTURE_PLAN.md](/home/auro/code/warcraft_cli/docs/architecture/AUTH_ARCHITECTURE_PLAN.md). `raidbots` should be treated as a likely future session/workflow auth consumer, not as a primary driver of the shared OAuth architecture.
