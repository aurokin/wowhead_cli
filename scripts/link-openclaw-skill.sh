...
# Link this repo's wowhead skill into OpenClaw's local skills directory.
#
# Usage:
...
SOURCE_SKILL_PATH="${OPENCLAW_SKILL_PATH:-$REPO_ROOT/skills/wowhead}"
